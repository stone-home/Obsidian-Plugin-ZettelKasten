...
export default class ZettelkastenPlugin extends Plugin {
	...
	async onload() {
		...
		this.app.workspace.onLayoutReady( async () => {
			...
			if (this.settings.kanbanEnabled) {
				const weeklyKanbanCommand = new WeeklyKanbanCommand(this.app, this, this.factory);
	...
	private async initializeZettelkastenFeatures() {
		this.zettelkastenCommand = new ZettelkastenCommand(this.app, this.factory, this);
